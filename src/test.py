...
def run(): #--serial 003066c2
    ...
    with anki_vector.Robot(serial=args.serial) as robot:
        ...
        # YOUR CODE HERE
        robot.behavior.say_text('3')
        time.sleep(3)
        print("version " + str(skimage.__version__))
        ...
        while not reached_goal:
            ...
            if not converged_final: #not converged
                ...
                if mean_good:
                    ...
                    h -= 10 #overshoot due to spinning
        ...
        while not robot.world.connected_light_cube:
            ...
            if (robot.world.connected_light_cube):
                ...
                robot.behavior.go_to_object(robot.world.connected_light_cube, distance_mm(60.0))
